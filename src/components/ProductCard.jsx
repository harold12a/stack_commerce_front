...
const ProductCard = ({ product }) => {
  return (
    <div className="mt-2 hover:scale-105 transition-transform transform bg-gradient-to-r from-t_background1 to-t_background3  border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="h-[120px] md:h-[170px] flex flex-col items-center justify-around gap-3 p-2 mb-4">
        <Anchor href="#">
          <h5 className="text-center text-lg md:text-xl font-bold tracking-tight text-white dark:text-white ">
            {product.name}
          </h5>
        </Anchor>
